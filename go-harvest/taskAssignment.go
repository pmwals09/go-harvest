...
type TaskAssignment struct {
	...
	HourlyRate float64               `json:"hourly_rate"` // Rate used when the project’s bill_by is Tasks.
	Budget     float64               `json:"budget"`      // Budget used when the project’s budget_by is task or task_fees.
