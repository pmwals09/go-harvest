...
type UserAssignment struct {
	...
	HourlyRate       float64   `json:"hourly_rate"`        // Custom rate used when the project’s bill_by is People and use_default_rates is false.
	Budget           float64   `json:"budget"`             // Budget used when the project’s budget_by is person.
